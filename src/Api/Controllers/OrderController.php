        ...
        register_rest_route(
            ...
            [
                [
                    ...
                    'args'                => [
                        'id' => [
                            'description'       => __( 'Unique identifier for the order.', 'meal-map' ),
                            'type'              => 'integer',
                            'required'          => false,
            ...
            [
                [
                    ...
                    'args'                => [
                        ...
                        'start_date' => [
                            'description'       => __( 'Start date for the report.', 'meal-map' ),
                            'required'          => false,
                            'type'              => 'string',
                            'sanitize_callback' => 'sanitize_text_field',
                        ],
                        'end_date'   => [
                            'description'       => __( 'End date for the report.', 'meal-map' ),
                            'required'          => false,
                            'type'              => 'string',
                            'sanitize_callback' => 'sanitize_text_field',
                        ],
